...
class PickBluetoothDevice extends StatefulWidget {
  /// If true, discovery starts on page start, otherwise user must press action button.
  final bool start;

  const PickBluetoothDevice({this.start = true});

  @override
  _PickBluetoothDevice createState() => _PickBluetoothDevice();
}

class _PickBluetoothDevice extends State<PickBluetoothDevice> {
